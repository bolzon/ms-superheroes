...
CREATE TABLE IF NOT EXISTS `AuditEvents` (`id` INTEGER UNSIGNED auto_increment , `entity` VARCHAR(255) NOT NULL, `entityId` INTEGER UNSIGNED NOT NULL, `datetime` DATETIME NOT NULL, `action` VARCHAR(255), `username` VARCHAR(255) NOT NULL, PRIMARY KEY (`id`), FOREIGN KEY (`username`) REFERENCES `Users` (`username`) ON DELETE NO ACTION ON UPDATE CASCADE);
